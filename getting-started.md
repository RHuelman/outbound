...
You need an AWS account to follow this tutorial on the AWS Amplify Console. There is no additional charge for using AWS Amplify with this tutorial. The resources you create in this tutorial are Free Tier eligible. You can sign up for AWS [here](https://portal.aws.amazon.com/billing/signup/iam?#/start)
